...
do
{
    var credits = ConsoleExtension.GetInt("Números de créditos......: ");
    var creditValue = ConsoleExtension.GetDecimal("Valor crédito............: ");
    var stratum = ConsoleExtension.GetInt("Estrato del estudiante...: ");

    var registrationValue = CalculateRegistationValue(credits, creditValue, stratum);
...
decimal CalculateRegistationValue(int credits, decimal creditValue, int stratum)
{
    decimal value;
    if (credits <= 20)
    {
